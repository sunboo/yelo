...
yelo is a mobile only, android first peer-to-peer marketplace. We are currently based in Bangalore. The 2 founders are Prasun (IIT Delhi, startup-exit with cash acquisition) & Khushboo (IIT Bombay, HBS, currently-Inmobi). The team has a phenomenal RoR developer, awesome Android+UI developer, great UX designer and top notch iOS developer (to join soon) besides having a great Android mentor.
